...
<body>
	...
	<div id="contents">
		...
		<div id="menuBar">
			<?php printMenuItem('main', 'Strona główna')?>
			<?php printMenuItem('about', 'O Golden Crop')?>
			<?php printMenuItem('faq', 'FAQ')?>
			<?php printMenuItem('download', 'Download')?>
			<?php printMenuItem('contact', 'Kontakt')?>
			<?php printMenuItem('changelog', 'Dziennik zmian')?>
			<?php printMenuItem('sourceforge', 'Zasoby Source Forge')?>
		</div>
